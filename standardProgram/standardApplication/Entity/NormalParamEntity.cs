...
namespace Entity
{
    public class NormalParamEntity
    {
        ...
        public List<NormalParamEntityForList> ConvertToNormalList()
        {
            ...
            normalList.Add(new NormalParamEntityForList() { Name1 = "声光报警开关:", Value1 = this.IfSoundAlert ? "打开" : "关闭", Name2 = "报警延时(秒):", Value2 = this.AlertDelay.ToString(), Name3 = "A1继电器模式:", Value3 = this.RelayModelA1.Name, Name4 = "A2继电器模式:", Value4 = this.RelayModelA2.Name });

            normalList.Add(new NormalParamEntityForList() { Name1 = "继电器1模式:", Value1 = this.RelayModel1.Name, Name2 = "继电器1对应通道:", Value2 = this.RelayMatchChannel1.ToString(), Name3 = "继电器1动作时间(秒):", Value3 = this.RelayActionTimeSpan1.ToString(), Name4 = "继电器1间隔时间(秒):", Value4 = this.RelayInterval1.ToString() });

            normalList.Add(new NormalParamEntityForList() { Name1 = "继电器2模式:", Value1 = this.RelayModel2.Name, Name2 = "继电器2对应通道:", Value2 = this.RelayMatchChannel2.ToString(), Name3 = "继电器2动作时间(秒):", Value3 = this.RelayActionTimeSpan2.ToString(), Name4 = "继电器2间隔时间(秒):", Value4 = this.RelayInterval2.ToString() });

            normalList.Add(new NormalParamEntityForList() { Name1 = "继电器3模式:", Value1 = this.RelayModel3.Name, Name2 = "继电器3对应通道:", Value2 = this.RelayMatchChannel3.ToString(), Name3 = "继电器3动作时间(秒):", Value3 = this.RelayActionTimeSpan3.ToString(), Name4 = "继电器3间隔时间(秒):", Value4 = this.RelayInterval3.ToString() });
